...
if (isset($_POST)) {
  ...
  if (empty($nom) || empty($prenom) || empty($email) || empty($passe)) {
    echo "Merci de remplir tous les champs du formulaire";
  } 
 
// Vérifier l'email taper par l'utilisateur :
    ...
    // hachage du mot de passe stocké en BD par la fonction md5
    $connexion->insereMembre($nom, $prenom, $email, md5($passe));
